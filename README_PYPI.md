...
| **C** (`.c` `.h`) | Built-in (opt-in deps) | `tree-sitter` | struct/union/enum members, typedefs, macros, `#include` tracking, per-TU `static` linkage, library entry mode |
