...
STRINGS: dict[str, str] = {
    ...
    "help.query": "查询依赖关系图",
    "help.build": "构建/重建索引",
    "help.install": "为 Agent 工具安装 graphlint（默认安装 skill；'install prompt' 注入配置文件，'install dsh' 安装 DeepSeek Harness 插件）",
    "help.install.actions": "安装目标",
    "help.install.skill": "将 graphlint SKILL.md 安装到 Agent skill 目录（默认 ~/.agents/skills）",
    "help.install.prompt": "将 graphlint 提示词注入 Agent 配置文件（旧行为）",
    "help.install.dsh": "将 dsh-graphlint 插件安装到 DeepSeek Harness profile",
