...
STRINGS: dict[str, str] = {
    ...
    "help.install": "Install graphlint for agent tools (skill by default; 'install prompt' injects into config files, 'install dsh' adds the DeepSeek Harness plugin)",
    "help.install.actions": "Install targets",
    "help.install.skill": "Install the graphlint SKILL.md into agent skill directories (~/.agents/skills by default)",
    "help.install.prompt": "Inject the graphlint prompt into agent config files (legacy behavior)",
    "help.install.dsh": "Install the dsh-graphlint plugin into a DeepSeek Harness profile",
